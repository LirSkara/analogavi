@extends('layout')
@section('title')
    Khalif - Редактирование машин
@endsection
@section('content')
    <div class="container" id="edit_cars">
        <div class="row mx-auto">
            <form id="edit_form_cars" class="col">
            @csrf
                ...
                <div class="row g-3 align-items-center mb-4">
                    ...
                    <div class="col-12 col-lg-6 d-flex mt-3">
                        <select name="when_pur_year" v-model="when_pur_year" class="form-select form-select-lg mb-3 me-2" aria-label=".form-select-lg example">
                        ...
                        <select name="when_pur_month" v-model="when_pur_month" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                ...
                <div class="col-auto mt-0">
                    <div class="form-floating mb-3">
                        <input type="text" name="vin" v-model="vin" class="form-control" id="floatingInput" placeholder="name@example.com">
                ...
                <div v-if="car_no_reg == false" class="col-auto mt-0">
                    <div class="form-floating mb-3">
                        <input type="text" name="ctc" v-model="ctc" class="form-control" id="floatingInput" placeholder="name@example.com">
                ...
                <button class="btn btn-primary w-100" v-on:click="add_cars()">Редактировать</button>
            </form>
    ...
    <script>
        const EditCars = {
            data() {
                return {
                    ...
                    price: '{{$car->price}}',
                    type_doc: '{{$car->type_doc}}',
                    owner_count: '{{$car->owner_count}}',
                    when_pur_month: '{{$car->when_pur_month}}',
                    when_pur_year: '{{$car->when_pur_year}}',
                    ...
                    owner_count_error: '',
                    state_number_error: '',
                    year_graduation: '{{$car->year_graduation}}',
                    month_graduation: '{{$car->month_graduation}}',
                    error_graduation: '',
                    marks: [],
                    models: [],
                    marks_models: [],
                    ...
                    model: '{{$marka->model}}',
                    year: '{{$marka->year}}',
                    body_type: '{{$marka->body_type}}',
                    gen: '{{$marka->gen}}',
                    engine_type: '{{$marka->engine_type}}',
                    drive: '{{$marka->drive}}',
                    transmission: '{{$marka->transmission}}',
                    horse_power: '{{$marka->horse_power}}',
                    mileage: '{{$marka->mileage}}',
                    gas_cylinder: '{{$marka->gas_cylinder}}',
                    car_selected: true,
                    search_cars: '',
                    search_models: '',
                    search_years: '',
            ...
            methods: {
                all() {
                    if('{{$car->year_graduation}}{{$car->month_graduation}}' != '') {
                        this.garant = true
                    } else {
                        this.garant = false
                    }

                    if('{{$car->car_no_reg}}' == 'true') {
                                        ...
                                        if(this.owner_count != '') {
                                            if(this.garant == false) {
                                                if(this.state_number != '' || this.car_no_reg == true) {
                                                    ...
                                                    var form_cars = new FormData($("#edit_form_cars")[0]);
    
                                                    axios({
                                                        method: 'post',
                                                        url: '/edit_cars/{{$car->id}}',
                                                        responseType: 'json',
                                                        data: form_cars,
                                                    })
                                                    .then(function (response) {
        ...
        Vue.createApp(EditCars).mount('#edit_cars')
    </script>
@endsection