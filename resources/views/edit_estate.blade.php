@extends('layout')
@section('title')
    Khalif - Редактирование недвижимости
@endsection
@section('content')

    <div class="container" id="edit_realty">
        ...
        <div v-if="res_two == true && sell_and_buy == 'Сдам' || res_two == true && sell_and_buy == 'Продам'">
            ...
            <button class="btn btn-primary w-700" v-on:click="resume_three()">Редактировать</button>
        </div>
    ...
    <script>
        const EditRealty = {
            data() {
                return {
                    ...
                    who_add: '{{$item->who_add}}',
                    online_display: '{{$item->online_display}}',
                    type_residential: '{{$item->type_residential}}',
                    floor: '{{$item->floor}}',
                    count_rooms: '{{$item->count_rooms}}',
                    square: '{{$item->square}}',
                    residential_square: '{{$item->residential_square}}',
                    type_home: '{{$item->type_home}}',
                    floor_home: '{{$item->floor_home}}',
                    elevator: '{{$item->elevator}}',
                    closed_territory: '{{$item->closed_territory}}',
                    children_playground: '{{$item->children_playground}}',
                    sports_ground: '{{$item->sports_ground}}',
                    parking: '{{$item->parking}}',
                    description: '{{$item->description}}',
                    method_sale: '{{$item->method_sale}}',
                    mortgage: '{{$item->mortgage}}',
                    sale_share: '{{$item->sale_share}}',
                    ...
                    may_children: '{{$item->may_children}}',
                    may_animal: '{{$item->may_animal}}',
                    allowed_smoke: '{{$item->allowed_smoke}}',
                    count_bed: '{{$item->count_bed}}',
                    count_sleeping_places: '{{$item->count_sleeping_places}}',
                    location: '{{$item->location}}',
                    object_type: '{{$item->object_type}}',
                    bath_or_sauna: '{{$item->bath_or_sauna}}',
                    ...
                    terrace_veranda: '{{$item->terrace_veranda}}',
                    square_region: '{{$item->square_region}}',
                    bathroom_home: '{{$item->bathroom_home}}',
                    bathroom_street: '{{$item->bathroom_street}}',
                        ...
                        if(this.price != '') {
                            if(this.what_i_sell == 'Квартиры') {
                                ...
                                if(this.sell_and_buy == 'Сдам') {
                                    ...
                                    axios({
                                        method: 'post',
                                        url: '/edit_apartment_rent/{{$item->id}}',
                                        responseType: 'json',
                                        data: {
                                            what_i_sell: this.what_i_sell,
                                            sell_and_buy: this.sell_and_buy,
                                ...
                                if(this.sell_and_buy == 'Куплю') {
                                    ...
                                    axios({
                                        method: 'post',
                                        url: '/edit_apartment_buy/{{$item->id}}',
                                        responseType: 'json',
                                        data: {
                                            what_i_sell: this.what_i_sell,
                                            sell_and_buy: this.sell_and_buy,
                                ...
                                if(this.sell_and_buy == 'Сниму') {
                                    ...
                                    axios({
                                        method: 'post',
                                        url: '/edit_apartment_take/{{$item->id}}',
                                        responseType: 'json',
                                        data: {
                                            what_i_sell: this.what_i_sell,
                                            sell_and_buy: this.sell_and_buy,
                            ...
                            if(this.what_i_sell == 'Земельные участки') {
                                ...
                                if(this.sell_and_buy == 'Сдам') {
                                    if(this.square != '') {
                                        ...
                                        axios({
                                            method: 'post',
                                            url: '/edit_land_plot_rent/{{$item->id}}',
                                            responseType: 'json',
                                            data: {
                                                what_i_sell: this.what_i_sell,
                                                sell_and_buy: this.sell_and_buy,
                                ...
                                if(this.sell_and_buy == 'Куплю') {
                                    ...
                                    axios({
                                        method: 'post',
                                        url: '/edit_land_plot_buy/{{$item->id}}',
                                        responseType: 'json',
                                        data: {
                                            what_i_sell: this.what_i_sell,
                                            sell_and_buy: this.sell_and_buy,
                                ...
                                if(this.sell_and_buy == 'Сниму') {
                                    ...
                                    axios({
                                        method: 'post',
                                        url: '/edit_land_plot_type/{{$item->id}}',
                                        responseType: 'json',
                                        data: {
                                            what_i_sell: this.what_i_sell,
                                            sell_and_buy: this.sell_and_buy,
        ...
        Vue.createApp(EditRealty).mount('#edit_realty')
    </script>
@endsection
