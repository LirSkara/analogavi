...
@endsection
@section('content')
    <div class="container" id="addtourism">
            ...
            @csrf
                ...
                <div class="row g-3 align-items-center mb-4">
                    <div class="col-12 col-lg-4 mt-0">
                        <label for="name" class="col-form-label">Название тура</label>
                    </div>
                    ...
                    <div class="col-auto mt-0">
                        ...
                        <div class="mt-3">
                            <span v-for="(item, id) in personal_images" key="id" style="width:100px;display:inline-block;">
                                <img width="100"
                                    :src="'/storage/tours_image/{{auth()->user()->id}}/' + item.image"
                                    alt="">
    ...
    <script>
        ...
        Vue.createApp(AddTourism).mount('#addtourism')
    </script>
@endsection
